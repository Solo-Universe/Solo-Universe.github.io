...
{: onclick="playVideoAt(248)"}

> `有个人爱你很久`
{: .chinese onclick="playVideoAt(248)"}
...
>> I translated this chapter in order to add the series to **NovelUpdates**. If anyone's interested in picking this up, feel free to do so! Otherwise, I'll follow along the [comic](https://manga.bilibili.com/detail/mc30550) pacing. You can contact me at [**this email**](mailto:shinimodoritl@gmail.com)
